...
def set_joint_positions():
    ...
    try:
        ...
        response = set_joint_state(
            ...
            joint_names=['right_hip_pitch_joint','left_hip_pitch_joint','right_hip_roll_joint','left_hip_roll_joint','left_knee_joint', 'right_knee_joint','left_hip_pitch_joint','right_hip_pitch_joint','left_ankle_joint','right_ankle_joint'],
